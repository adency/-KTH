...
public class TCPAsk {
    ...
    public static void main( String[] args) {
        ...
        try {
            ...
            /*creates a byte array for the reply, and calls the askServer function using the host, port and userInputByte*/
            byte[] serverBytes  = tcpClient.askServer(hostname, port, userInputBytes); 
            /*Creates a string and puts the serverBytes(server reply) in the new string*/
            String serverOutput = new String(serverBytes);
            /*Prints out the reply */
